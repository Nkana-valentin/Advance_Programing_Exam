...
for i in 16 32 64 128 512 1024 2048 4096 8192 16384 32768 65536 131072
do
 ./benchmark.x $i > times_$i.txt
done

for i in 16 32 64 128 1024 2048 4096 8192 16384 32768 65536 131072
do 
head -n 11 times_$i.txt > tree_unbalanced_$i.txt
head -n 23 times_$i.txt|tail -n 11 > tree_unbalanced_$i.txt
